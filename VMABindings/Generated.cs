...
namespace VMASharp.Native
{
    ...
    public unsafe partial struct VmaVulkanFunctions
    {
        ...
        public delegate* unmanaged[Stdcall]<VkDevice*, VkDeviceMemory*, ulong, ulong, uint, void**, VkResult> vkMapMemory;
    ...
    public static unsafe partial class VmaNative
    {
        ...
        public static extern void GetPoolName([NativeTypeName("VmaAllocator _Nonnull")] VmaAllocator* allocator, [NativeTypeName("VmaPool _Nonnull")] VmaPool* pool, [NativeTypeName("const char * _Nullable * _Nonnull")] sbyte** ppName);

        [DllImport("vma", CallingConvention = CallingConvention.Cdecl, EntryPoint = "vmaSetPoolName", ExactSpelling = true)]
        public static extern void SetPoolName([NativeTypeName("VmaAllocator _Nonnull")] VmaAllocator* allocator, [NativeTypeName("VmaPool _Nonnull")] VmaPool* pool, [NativeTypeName("const char * _Nullable")] sbyte* pName);
        ...
        public static extern void SetAllocationName([NativeTypeName("VmaAllocator _Nonnull")] VmaAllocator* allocator, [NativeTypeName("VmaAllocation _Nonnull")] VmaAllocation* allocation, [NativeTypeName("const char * _Nullable")] sbyte* pName);
        ...
        public static extern void BuildVirtualBlockStatsString([NativeTypeName("VmaVirtualBlock _Nonnull")] VmaVirtualBlock* virtualBlock, [NativeTypeName("char * _Nullable * _Nonnull")] sbyte** ppStatsString, [NativeTypeName("VkBool32")] uint detailedMap);

        [DllImport("vma", CallingConvention = CallingConvention.Cdecl, EntryPoint = "vmaFreeVirtualBlockStatsString", ExactSpelling = true)]
        public static extern void FreeVirtualBlockStatsString([NativeTypeName("VmaVirtualBlock _Nonnull")] VmaVirtualBlock* virtualBlock, [NativeTypeName("char * _Nullable")] sbyte* pStatsString);

        [DllImport("vma", CallingConvention = CallingConvention.Cdecl, EntryPoint = "vmaBuildStatsString", ExactSpelling = true)]
        public static extern void BuildStatsString([NativeTypeName("VmaAllocator _Nonnull")] VmaAllocator* allocator, [NativeTypeName("char * _Nullable * _Nonnull")] sbyte** ppStatsString, [NativeTypeName("VkBool32")] uint detailedMap);

        [DllImport("vma", CallingConvention = CallingConvention.Cdecl, EntryPoint = "vmaFreeStatsString", ExactSpelling = true)]
        public static extern void FreeStatsString([NativeTypeName("VmaAllocator _Nonnull")] VmaAllocator* allocator, [NativeTypeName("char * _Nullable")] sbyte* pStatsString);
    }
}
