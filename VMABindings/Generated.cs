...
using static VMASharp.VmaAllocationCreateFlagBits;
...
namespace VMASharp
{
    ...
    public unsafe partial struct VmaVulkanFunctions
    {
        ...
        [NativeTypeName("PFN_vkGetMemoryWin32HandleKHR _Nullable")]
    ...
    public static unsafe partial class Vma
    {
        ...
        public static extern void GetMemoryTypeProperties([NativeTypeName("VmaAllocator _Nonnull")] VmaAllocator allocator, [NativeTypeName("uint32_t")] uint memoryTypeIndex, [NativeTypeName("VkMemoryPropertyFlags * _Nonnull")] VkMemoryPropertyFlagBits* pFlags);
        ...
        public static extern void GetAllocationMemoryProperties([NativeTypeName("VmaAllocator _Nonnull")] VmaAllocator allocator, [NativeTypeName("VmaAllocation _Nonnull")] VmaAllocation allocation, [NativeTypeName("VkMemoryPropertyFlags * _Nonnull")] VkMemoryPropertyFlagBits* pFlags);
